...
import 'package:event/devices/phone/widget/card-events-home-widget-phone.dart';
import 'package:event/devices/phone/widget/categorie-widget-phone.dart';
import 'package:event/devices/phone/widget/menu-app-btn.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(boxShadow: [
                    BoxShadow(blurRadius: 20, color: ColorByDii.blanc())
                  ]),
    ...
    if (liste.length == 1) {
      liste.add(Container(
        ...
        child: Center(
          ...
          valueColor: AlwaysStoppedAnimation<Color>(ColorByDii.noir()),
        )),
      ));
    }
    return liste;
